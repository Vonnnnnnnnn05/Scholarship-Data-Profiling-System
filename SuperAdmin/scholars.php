        ...
        <div class="card">
            <div class="stats-bar">
                <div class="stat-item">
                    ...
                    <span>Total Scholars: <strong><?php echo number_format($total_records); ?></strong></span>
                </div>
                <div class="stat-item">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <button onclick="deleteScholar(<?php echo $scholar['id']; ?>)" class="btn btn-danger btn-sm">
                            ...
                            <tr>
                                <td colspan="9">
                                    <div class="empty-state">
                                        ...
                                        <p>Try adjusting your filters or add a new scholar.</p>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
