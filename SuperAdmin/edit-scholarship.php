...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Check for duplicate name (excluding current scholarship)
    $stmt = $conn->prepare("SELECT id FROM scholarships WHERE scholarship_name = ? AND id != ?");
    $stmt->bind_param("si", $scholarship_name, $scholarship_id);
    $stmt->execute();
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input 
                        ...
                        value="<?php echo htmlspecialchars($scholarship['scholarship_name']); ?>"
                        required
