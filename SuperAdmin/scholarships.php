...
<head>
    ...
    <title>Scholarships Management - SKSU SDP</title>
        ...
        function deleteScholarship(id, name, scholarCount) {
            if (scholarCount > 0) {
                Swal.fire({
                    icon: 'warning',
                    title: 'Cannot Delete',
                    text: `This scholarship "${name}" has ${scholarCount} enrolled scholar(s). Please remove or reassign the scholars first.`,
